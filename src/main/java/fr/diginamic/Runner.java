...
public class Runner {
    public static void main(String[] args) {
        ...
        csvService.traitementDesGenres("D:/Cours_CDA/17 - Projet en équipe - développement d'une application JAVA avec JPA/Projet 4 - Internet Movie DataBase - niveau 3/films.csv");
